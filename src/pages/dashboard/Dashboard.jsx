        ...
        <Grid padded style={{ height: "80vh" }}>
          <Grid.Column stretched width={4}>
            <Menu fluid vertical tabular>
              ...
              <Menu.Item
                name="Trening"
                active={activeItem === "Trening"}
                onClick={this.handleItemClick}
              />
              <Menu.Item
                name="Dieta"
                active={activeItem === "Dieta"}
                onClick={this.handleItemClick}
              />
              <Menu.Item
                name="Sylwetka"
                active={activeItem === "Sylwetka"}
                onClick={this.handleItemClick}
              />
              <Menu.Item
                name="Suplementacja"
                active={activeItem === "Suplementacja"}
                onClick={this.handleItemClick}
              />
            </Menu>
          </Grid.Column>
          ...
          <Grid.Column stretched width={12}>
            <Segment>
              ...
              {activeItem === "Trening" && (
                <Training popUp={this.handlePopUp} />
              )}
